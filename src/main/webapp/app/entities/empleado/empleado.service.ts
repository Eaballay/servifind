...
export class EmpleadoService {
  ...
  protected convertDateFromClient(empleado: IEmpleado): IEmpleado {
    const copy: IEmpleado = Object.assign({}, empleado, {
      fechaDeContratacion:
        empleado.fechaDeContratacion != null && empleado.fechaDeContratacion.isValid() ? empleado.fechaDeContratacion.toJSON() : null
    });
    return copy;
  }
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      res.body.fechaDeContratacion = res.body.fechaDeContratacion != null ? moment(res.body.fechaDeContratacion) : null;
    }
    return res;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((empleado: IEmpleado) => {
        empleado.fechaDeContratacion = empleado.fechaDeContratacion != null ? moment(empleado.fechaDeContratacion) : null;
      });
    }
    return res;
  }
