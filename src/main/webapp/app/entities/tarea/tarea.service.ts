...
export class TareaService {
  ...
  protected convertDateFromClient(tarea: ITarea): ITarea {
    const copy: ITarea = Object.assign({}, tarea, {
      fechaDeCreacion: tarea.fechaDeCreacion != null && tarea.fechaDeCreacion.isValid() ? tarea.fechaDeCreacion.toJSON() : null,
      fechaDeModificacion:
        tarea.fechaDeModificacion != null && tarea.fechaDeModificacion.isValid() ? tarea.fechaDeModificacion.toJSON() : null
    });
    return copy;
  }
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      ...
      res.body.fechaDeModificacion = res.body.fechaDeModificacion != null ? moment(res.body.fechaDeModificacion) : null;
    }
    return res;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((tarea: ITarea) => {
        tarea.fechaDeCreacion = tarea.fechaDeCreacion != null ? moment(tarea.fechaDeCreacion) : null;
        tarea.fechaDeModificacion = tarea.fechaDeModificacion != null ? moment(tarea.fechaDeModificacion) : null;
      });
    }
    return res;
  }
