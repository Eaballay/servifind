...
describe('Service Tests', () => {
  describe('Asociado Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a Asociado', async () => {
      ...
      it('should update a Asociado', async () => {
        const returnedFromService = Object.assign(
          {
            nroDeAsociado: 1
          },
      ...
      it('should return a list of Asociado', async () => {
        const returnedFromService = Object.assign(
          {
            nroDeAsociado: 1
          },
      ...
      it('should delete a Asociado', async () => {
